...
const About = () => (
  <section className={`${style.paddings} relative z-10`}>
    ...
    >
      <TypingText title="| About Soy Yo" textStyles="text-center" />
      <motion.p
        variants={fadeIn('up', 'tween', 0.2,1)}
        className="mt-[8px] font-normal sm:text-[32px] text-center text-secondary-white"
      >
        <span className="font-extrabold text-white">SOY YO </span> 
        ...
        <span className="font-extrabold text-white"> madness of the metaverse of today </span>
        , using only  
